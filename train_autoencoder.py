...
# -------------------------------------------------------
def train(data, img_flag, modality):
	...
	for e in range(args.epochs):
		...
		# save loss
		save_model_filename = f'loss_data_trans_{modality}_e{e}.mat'
		loss_filename_path = os.path.join(temp_path_loss, save_model_filename)
		scio.savemat(loss_filename_path, {'loss_data': loss_mat})
		# save model
		model.eval()
		model.cpu()
		save_model_filename = f"auto_encoder_epoch_{e + 1}_{modality}.model"
...
if __name__ == "__main__":
	...
	modality = args.type_flag
	train(data, img_flag, modality)
